...
Partial Class NewStory
    ...
    Private Sub LogRequestInDatabase()
        ...
        With cmd
            ...
            .CommandText = "UPDATE dbo.CHKC_Members SET [ECard] = 1 " + _
    ...
    Private Sub SendEmail()
        ...
        With sb
            .Append("The following CH kitty is registering for birthday e-cards:")
            .Append(vbCrLf)
            .Append(vbCrLf)
            .Append("Username: ")
        ...
        Dim msg As New MailMessage(Server.HtmlEncode(TextBoxEmail.Text), _
                                   ...
                                   "New CH Kitty Birthday E-Card Registration", _
                                   sb.ToString)
