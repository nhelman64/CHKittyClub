<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Members.aspx.vb" Inherits="Members" %>
        ...
        <div class="post">
            <div class="entry">
                ...
                <asp:SqlDataSource ID="SqlDataSourcePhotos" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:CHKittyClub %>" 
                    SelectCommand="SELECT [Filename], [Caption] FROM [CHKC_Photos] WHERE [MemberID] = @MemberID AND [Approved] = 1 ORDER BY [Caption]">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="MemberList" Name="MemberID" 
                            PropertyName="SelectedValue" Type="Int32" />
                    </SelectParameters>
                ...
                <ul>
                    <li>
                        <asp:ListBox ID="MemberList" runat="server" 
                            ...
                            BackColor="#FCF9E8" Width="236px"></asp:ListBox>
                        <asp:SqlDataSource ID="SqlDataSourceMemberNames" runat="server" 
                            ...
                            <SelectParameters>
                                ...
                                <asp:Parameter DefaultValue="0" Name="OtherHandicap" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </li>
                    <li>Click here to <a href="OtherHandicaps.aspx"><span style="font-weight:bold">see stories of our members' kitties that have handicaps other than CH</span></a></li>
                </ul>
            </li>
