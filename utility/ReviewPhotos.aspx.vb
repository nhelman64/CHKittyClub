...
Partial Class Members
    ...
    Protected Sub approveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles approveButton.Click
        If MemberList.SelectedIndex > -1 Then
            ...
            Dim sBody As String = "Congratulations!  The photos you generously shared with us at the CH Kitty Club has been approved." + _
                vbCrLf + vbCrLf + "Thanks for sharing, and thanks for your support."
            ...
            Server.Transfer("ReviewPhotos.aspx")
        End If
    End Sub
    ...
    Protected Sub disapproveButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles disapproveButton.Click
        If MemberList.SelectedIndex > -1 Then
            ...
            Dim sBody As String = "Unfortunately, we have rejected the photos you shared with us at the CH Kitty Club.  We definitely appreciate your sharing it, and would like to work with you on making it an acceptable story." + _
                vbCrLf + vbCrLf + "Thanks for sharing, and thanks for your support."

            If sTo <> "" Then
                Dim msg As New MailMessage(sFrom, sTo, "Your CH Kitty Club photos have been rejected!", sBody)
